...
export const COMMAND_MANIFEST_SOURCE: readonly CommandManifestEntry[] = [
  ...
  },
  {
    ...
    "compatibilityAliases": [],
    "deprecatedAliases": [],
    "args": "[list|doctor [drive]|repair]",
    "summary": "manage and diagnose MCP servers",
    "detailedHelp": "aether mcp [list|doctor [drive]|repair]\nmanage and diagnose MCP servers; doctor drive reads Cloud's staff Drive readiness",
    "section": "System",
    "hidden": false,
    "permissionClass": "network",
    "availability": {
    ...
    "docs": {
      ...
      "symbol": "COMMAND_MANIFEST_SOURCE",
      "target": "mcp",
      "usage": "aether mcp [list|doctor [drive]|repair]",
      "visible": true,
      "disposition": "generated"
    },
    "release": {
  ...
  },
  {
    ...
    "args": "[list|doctor [drive]|repair]",
    "summary": "manage and diagnose MCP servers",
    "detailedHelp": "/mcp [list|doctor [drive]|repair]\nmanage and diagnose MCP servers; doctor drive reads Cloud's staff Drive readiness",
    "section": "Session",
    "hidden": false,
    "permissionClass": "unknown",
    "availability": {
    ...
    "docs": {
      ...
      "symbol": "COMMAND_MANIFEST_SOURCE",
      "target": "mcp",
      "usage": "/mcp [list|doctor [drive]|repair]",
      "visible": true,
      "disposition": "generated"
    },
    "release": {
  ...
  },
  {
    ...
    "compatibilityAliases": [],
    "deprecatedAliases": [],
    "args": "status|mode|strategies|library|data|journal|browser",
    "summary": "configure ATS setup inside a managed agent chat",
    "detailedHelp": "/ats status|mode|strategies|library|data|journal|browser\nInspect local memory and strategies, install reviewed bundled Nano sources, select plan|skip|danger preference, configure data, dump the local journal, or manage the browser. Available inside aether agent chat <id> for a locally configured ATS agent. Sources and preferences do not enable live orders.",
    "section": "Managed agent chat",
    "hidden": false,
    "permissionClass": "local-write",
    "availability": {
    ...
    "docs": {
      ...
      "symbol": "COMMAND_MANIFEST_SOURCE",
      "target": "ats",
      "usage": "/ats status|mode|strategies|library|data|journal|browser",
      "visible": true,
      "disposition": "generated"
    },
    "release": {
