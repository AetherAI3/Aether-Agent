...
// browser_order.ts. The equity ticker and the closed-charset masked label
// live in primitives.ts, shared with the Spec 1 `/2` shapes.

import { ORDER_SIDES, ORDER_TYPES, type OrderSide, type OrderType } from "./grant.js";
import { choice, closed, digest, equityTicker, fail, ident, integer, nullable, opaqueRef, pinned, version } from "./primitives.js";
